...
export default function IssueReturnList() {
     const [openFilter, setOpenFilter] = useState<"entries" | "action" | "pagination" | "export" | null>(null);

     const toggleFilter = (type: "entries" | "action" | "pagination" | "export") => {
          setOpenFilter(openFilter === type ? null : type);
     };

     const issueReturnData = [
          { item: "Staff Unform", note: "", category: "Staff Dress", issueReturn: "12/27/2025 - 12/01/2025", issueTo: "William Abbot (9003)", issuedBy: "Shivam Verma (9002)", quantity: "2", status: "Click To Return" },
          { item: "Projectors", note: "", category: "Chemistry Lab Apparatus", issueReturn: "12/22/2025 - 12/27/2025", issueTo: "Jason Sharlton (90006)", issuedBy: "Joe Black (9000)", quantity: "2", status: "Click To Return" },
          { item: "Benches", note: "", category: "Furniture", issueReturn: "12/17/2025 - 12/04/2025", issueTo: "Maria Ford (9005)", issuedBy: "Brandon Heart (9006)", quantity: "5", status: "Returned" },
          { item: "Notebooks", note: "", category: "Books Stationery", issueReturn: "12/06/2025 - 12/13/2025", issueTo: "Brandon Heart (9006)", issuedBy: "Shivam Verma (9002)", quantity: "5", status: "Click To Return" },
          { item: "Class Board", note: "", category: "Books Stationery", issueReturn: "12/03/2025 - 12/03/2025", issueTo: "Shivam Verma (9002)", issuedBy: "William Abbot (9003)", quantity: "2", status: "Returned" },
          { item: "Staff Unform", note: "", category: "Staff Dress", issueReturn: "11/27/2025 - 11/01/2025", issueTo: "William Abbot (9003)", issuedBy: "Shivam Verma (9002)", quantity: "2", status: "Click To Return" },
          { item: "Projectors", note: "", category: "Chemistry Lab Apparatus", issueReturn: "11/22/2025 - 11/27/2025", issueTo: "Jason Sharlton (90006)", issuedBy: "Joe Black (9000)", quantity: "2", status: "Click To Return" },
          { item: "Benches", note: "", category: "Furniture", issueReturn: "11/17/2025 - 11/04/2025", issueTo: "Maria Ford (9005)", issuedBy: "Brandon Heart (9006)", quantity: "5", status: "Returned" },
          { item: "Notebooks", note: "", category: "Books Stationery", issueReturn: "11/06/2025 - 11/13/2025", issueTo: "Brandon Heart (9006)", issuedBy: "Shivam Verma (9002)", quantity: "5", status: "Click To Return" },
          { item: "Class Board", note: "", category: "Books Stationery", issueReturn: "11/03/2025 - 11/03/2025", issueTo: "Shivam Verma (9002)", issuedBy: "William Abbot (9003)", quantity: "2", status: "Returned" },
          { item: "Staff Unform", note: "", category: "Staff Dress", issueReturn: "10/27/2025 - 10/01/2025", issueTo: "William Abbot (9003)", issuedBy: "Shivam Verma (9002)", quantity: "2", status: "Click To Return" },
          { item: "Projectors", note: "", category: "Chemistry Lab Apparatus", issueReturn: "10/22/2025 - 10/27/2025", issueTo: "Jason Sharlton (90006)", issuedBy: "Joe Black (9000)", quantity: "2", status: "Click To Return" },
          { item: "Benches", note: "", category: "Furniture", issueReturn: "10/16/2025 - 10/04/2025", issueTo: "Maria Ford (9005)", issuedBy: "Brandon Heart (9006)", quantity: "5", status: "Returned" },
          { item: "Notebooks", note: "", category: "Books Stationery", issueReturn: "10/06/2025 - 10/13/2025", issueTo: "Brandon Heart (9006)", issuedBy: "Shivam Verma (9002)", quantity: "5", status: "Click To Return" },
          { item: "Class Board", note: "", category: "Books Stationery", issueReturn: "10/02/2025 - 10/02/2025", issueTo: "Shivam Verma (9002)", issuedBy: "William Abbot (9003)", quantity: "2", status: "Returned" },
     ];
                                        ...
                                        <table className="w-full">
                                             <thead>
                                                  <tr className="border-b border-bgray-300 dark:border-darkblack-400">
                                                       ...
                                                       <td className="py-5 px-6 xl:px-0">
                                                            <div className="w-full flex space-x-2.5 items-center">
                                                                 <span className="text-base font-medium text-bgray-600 dark:text-bgray-50">Issue - Return</span>
                                                                 <span>
                                                                      <svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                           <path d="M10.332 1.31567V13.3157" stroke="#718096" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                                                           <path d="M5.66602 11.3157L3.66602 13.3157L1.66602 11.3157" stroke="#718096" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                                       ...
                                                       <td className="py-5 px-6 xl:px-0">
                                                            <div className="w-full flex space-x-2.5 items-center">
                                                                 <span className="text-base font-medium text-bgray-600 dark:text-bgray-50">Issue To</span>
                                                                 <span>
                                                                      <svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                           <path d="M10.332 1.31567V13.3157" stroke="#718096" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                                                           <path d="M5.66602 11.3157L3.66602 13.3157L1.66602 11.3157" stroke="#718096" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                                       ...
                                                       <td className="py-5 px-6 xl:px-0">
                                                            <div className="w-full flex space-x-2.5 items-center">
                                                                 <span className="text-base font-medium text-bgray-600 dark:text-bgray-50">Issued By</span>
                                                                 <span>
                                                                      <svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                           <path d="M10.332 1.31567V13.3157" stroke="#718096" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                                                           <path d="M5.66602 11.3157L3.66602 13.3157L1.66602 11.3157" stroke="#718096" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                             ...
                                             <tbody>
                                                  {issueReturnData.map((item, index) => (
                                                       <tr key={index} className="border-b border-bgray-300 dark:border-darkblack-400">
                                                            ...
                                                            <td className="py-5 px-6 xl:px-0">
                                                                 {item.status === "Click To Return" ? (
                                                                      <span className="px-4 py-2 rounded-md bg-pink-500 text-white text-xs font-semibold inline-block">
                                                                           Click To Return
                                                                      </span>
                                                                 ) : (
                                                                      <span className="px-4 py-2 rounded-md bg-success-300 text-white text-xs font-semibold inline-block">
                                                                           Returned
                                                                      </span>
                                                                 )}
                                                            </td>
                                        ...
                                        <div className="w-full flex lg:justify-between justify-center items-center">
                                             <div className="lg:flex hidden space-x-4 items-center">
                                                  ...
                                                  <div className="relative">
                                                       ...
                                                       >
                                                            <span className="text-sm font-semibold text-bgray-900 dark:text-bgray-50">15</span>
                                                            <span>
                                                                 <svg
                                                                      width="17"
                                                                      height="17"
                                                       ...
                                                       >
                                                            <ul>
                                                                 ...
                                                                 <li className="text-sm font-medium text-bgray-900 dark:text-white cursor-pointer px-5 py-2 hover:bg-bgray-100 hover:dark:bg-darkblack-600">15</li>
                                                                 <li className="text-sm font-medium text-bgray-900 dark:text-white cursor-pointer px-5 py-2 hover:bg-bgray-100 hover:dark:bg-darkblack-600">20</li>
                                                            </ul>
                                                       </div>
                                                  </div>
                                             </div>
