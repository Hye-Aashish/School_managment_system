     ...
     const observationData = [
          {
               ...
               description: "In an observational study, researchers study how participants perform certain behaviours or activities without telling them what methods or behaviours to choose.",
               parameters: [
                    { name: "Behaviour", maxMarks: 20 },
                    { name: "Art & Culture", maxMarks: 25 }
               ]
          },
          {
               ...
               description: "In an observational study, researchers study how participants perform certain behaviours or activities without telling them what methods or behaviours to choose.",
               parameters: [
                    { name: "Game", maxMarks: 30 },
                    { name: "Painting", maxMarks: 20 }
               ]
          },
          {
               observation: "Cbse Exam Observation 3",
               description: "In an observational study, researchers study how participants perform certain behaviours or activities without telling them what methods or behaviours to choose.",
               parameters: [
                    { name: "Behaviour", maxMarks: 20 }
               ]
                                             ...
                                             <tbody>
                                                  {observationData.map((item, index) => (
                                                       <tr key={index} className="border-b border-bgray-300 dark:border-darkblack-400">
                                                            ...
                                                            <td className="py-5 px-6 xl:px-0 align-top">
                                                                 <p className="font-normal text-sm text-bgray-600 dark:text-bgray-300 max-w-2xl">
                                                                      {item.description}
                                                                 </p>
                                                            </td>
                                                            <td className="py-5 px-6 xl:px-0 align-top">
                                                                 <div className="flex flex-col space-y-1">
                                                                      {item.parameters.map((param, paramIndex) => (
                                                                           <p key={paramIndex} className="font-medium text-sm text-bgray-900 dark:text-bgray-50">
                                                                                {param.name}
                                                                           </p>
                                                                      ))}
                                                                 </div>
