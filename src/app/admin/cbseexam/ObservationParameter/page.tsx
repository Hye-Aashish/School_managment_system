                              ...
                              <div className="w-full py-6 px-6 rounded-lg bg-white dark:bg-darkblack-600 max-w-[400px]">
                                   <div className="flex flex-col space-y-5">
                                        ...
                                        <div className="w-full space-y-4">
                                             ...
                                             <button
                                                  type="button"
                                                  className="px-6 py-2.5 rounded-lg bg-success-300 hover:bg-success-400 dark:bg-success-300 text-nowrap dark:hover:bg-success-400 text-white font-semibold transition-colors w-full flex items-center justify-center"
                                             >
                                                  Save
                                             </button>
                                        </div>
