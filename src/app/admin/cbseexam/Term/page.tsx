                         ...
                         <div className="w-full py-[20px] px-[24px] rounded-lg bg-white dark:bg-darkblack-600">
                              <div className="flex flex-col space-y-5">
                                   ...
                                   <div className="w-full flex justify-between items-center space-x-4">
                                        ...
                                        {/* Records Per Page and Export Icons */}
                                        <div className="flex items-center space-x-3">
                                             ...
                                             <div className="relative">
                                                  <select
                                                       ...
                                                       className="h-10 px-4 pr-8 rounded-lg border border-bgray-300 dark:border-darkblack-400 bg-white dark:bg-darkblack-500 text-sm font-medium text-bgray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-success-300 appearance-none cursor-pointer"
                                                  >
                                                  ...
                                                  <div className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none">
                                                       <svg width="12" height="8" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M1 1.5L6 6.5L11 1.5" stroke="#718096" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                                       </svg>
                                                  </div>
                                             </div>
                                             ...
                                             <button type="button" className="text-bgray-500 hover:text-bgray-900 dark:hover:text-white transition-colors" title="Excel">
                                                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                       ...
                                                       <path d="M8.33203 10H11.6654" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
                                                       <path d="M8.33203 13.3333H11.6654" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
                                                  </svg>
                                             </button>
                                             ...
                                             <tbody>
                                                  {termData.map((item, index) => (
                                                       <tr key={index} className="border-b border-bgray-300 dark:border-darkblack-400">
                                                            ...
                                                            <td className="py-5 px-6 xl:px-0">
                                                                 <p className="font-medium text-base text-bgray-900 dark:text-bgray-50">{item.code}</p>
                                                            </td>
                                                            <td className="py-5 px-6 xl:px-0">
                                                                 <p className="font-normal text-sm text-bgray-600 dark:text-bgray-300 max-w-4xl">{item.description}</p>
                                                            </td>
                                                            <td className="py-5 px-6 xl:px-0">
