                         ...
                         <div className="w-full py-[20px] px-[24px] rounded-lg bg-white dark:bg-darkblack-600">
                              <div className="flex flex-col space-y-5">
                                   <div className="w-full flex h-14 space-x-4">
                                        ...
                                        <button type="button" className="py-3.5 flex items-center justify-center text-white font-bold bg-success-300 hover:bg-success-400 transition-all rounded-lg text-nowrap px-4">Add Book</button>
                                   </div>
                                                  ...
                                                  <tr className="border-b border-bgray-300 dark:border-darkblack-400">
                                                       ...
                                                       <td className="py-5 px-6 xl:px-0">
                                                            <div className="flex space-x-2 items-center">
                                                                 <button
                                                                      type="button"
                                                                      className="hover:text-bgray-700 dark:hover:text-white"
                                                                 >
                                                                      <svg
                                                                           width="16"
                                                                           height="16"
                                                                      ...
                                                                      >
                                                                           <path
                                                                                d="M12.6667 1.99992L14 3.33325L7.33333 9.99992L6 11.3333L2 12.6666L3.33333 8.66659L4.66667 7.33325L11.3333 0.666586L12.6667 1.99992Z"
                                                                                stroke="currentColor"
                                                                                strokeWidth="1.5"
                                                                                strokeLinecap="round"
                                                                                strokeLinejoin="round"
