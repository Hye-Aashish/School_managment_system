                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-bgray-300 dark:border-darkblack-400">
                      {isVisible("classTitle") && <td className="py-4 px-4 text-sm font-semibold text-bgray-600 dark:text-white">Class Title</td>}
                      ...
                      {isVisible("createdFor") && <td className="py-4 px-4 text-sm font-semibold text-bgray-600 dark:text-white">Created For</td>}
                  ...
                  <tbody>
                    {isLoading ? (
                      <tr><td colSpan={9} className="text-center py-4 text-bgray-600 dark:text-white">Loading...</td></tr>
                    ) : filtered.length === 0 ? (
                      <tr><td colSpan={9} className="text-center py-4 text-bgray-600 dark:text-white"> {searchQuery ? "No matching Zoom classes found." : "No Zoom live classes found."} </td></tr>
                    ) : (
                      filtered.map((item) => (
                        <tr key={item._id} className="border-b border-bgray-300 dark:border-darkblack-400 hover:bg-bgray-100 dark:hover:bg-darkblack-500 transition duration-200">
                          {isVisible("classTitle") && <td className="py-4 px-4 text-sm text-bgray-900 dark:text-white">{item.classTitle}</td>}
                          ...
                          {isVisible("createdFor") && <td className="py-4 px-4 text-sm text-bgray-900 dark:text-white">{item.createdFor}</td>}
