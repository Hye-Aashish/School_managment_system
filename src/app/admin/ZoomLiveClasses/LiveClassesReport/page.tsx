                ...
                <>
                  <div className="overflow-x-auto">
                    <table className="w-full">
                      <thead><tr className="border-b border-bgray-200 dark:border-darkblack-400 bg-bgray-50 dark:bg-darkblack-500">{["Admission No", "Student Name", "Father Name", "Last Join"].map(h => (<th key={h} className="text-left py-3 px-5 text-sm font-semibold text-bgray-700 dark:text-white">{h}</th>))}</tr></thead>
        ...
        <section className="2xl:flex-1 2xl:mb-0 mb-6">
          ...
          <div className="w-full py-[20px] px-[24px] rounded-lg bg-white dark:bg-darkblack-600">
            <div className="flex flex-col space-y-5">
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead><tr className="border-b border-bgray-300 dark:border-darkblack-400">{["Class Title","Description","Date Time","Created By","Created For","Total Join"].map(l => (<td key={l} className="py-4 px-4 text-sm font-semibold text-bgray-600 dark:text-white">{l}</td>))}<td>Action</td></tr></thead>
