                              ...
                              <div className="flex flex-col space-y-4">
                                   <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div className="flex flex-col">
                                             <label className="text-sm font-medium text-bgray-900 dark:text-bgray-50 mb-2">
                                                  Class <span className="text-error-300">*</span>
                                             </label>
                                             <div className="relative">
                                                  <button
                                                       type="button"
                                                       className="w-full h-12 rounded-lg bg-bgray-100 dark:bg-darkblack-500 px-4 flex justify-between items-center border border-bgray-300 dark:border-darkblack-400"
                                                       onClick={() => toggleFilter("class")}
                                                  >
                                                       <span className="text-sm text-bgray-900 dark:text-bgray-50">{selectedClass}</span>
                                                       <span>
                                                            <svg
                                                                 width="21"
                                                                 height="21"
                                                  ...
                                                  <div
                                                       className={`rounded-lg w-full shadow-lg bg-white dark:bg-darkblack-500 absolute left-0 z-10 top-14 overflow-hidden transition-all ${openFilter === "class" ? "block" : "hidden"
                                                            }`}
                                                  >
                                        ...
                                        <div className="flex flex-col">
                                             <label className="text-sm font-medium text-bgray-900 dark:text-bgray-50 mb-2">
                                                  Section <span className="text-error-300">*</span>
                                             </label>
                                             <div className="relative">
                                                  <button
                                                       type="button"
                                                  ...
                                                  >
                                                       <span className="text-sm text-bgray-900 dark:text-bgray-50">{selectedSection}</span>
                                                       <span>
                                                            <svg
                                                                 width="21"
                                                                 height="21"
                                                  ...
                                                  <div
                                                       className={`rounded-lg w-full shadow-lg bg-white dark:bg-darkblack-500 absolute left-0 z-10 top-14 overflow-hidden transition-all ${openFilter === "section" ? "block" : "hidden"
                                                            }`}
                                                  >
                                                       <ul className="max-h-48 overflow-y-auto">
                              ...
                              <div className="flex flex-col space-y-5">
                                   ...
                                   <div className="table-content w-full overflow-x-auto">
                                        <table className="w-full">
                                             ...
                                             <tbody>
                                                  {liveClassesReportData.map((item) => (
