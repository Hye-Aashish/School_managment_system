...
export default function LiveMeetingReport() {
  ...
  const handleCsvDownload = () => {
    ...
    a.href = url; a.download = "live-meeting-report.csv"; a.click();
  ...
  const handleExcelDownload = () => {
    ...
    const url = URL.createObjectURL(blob);
    const a = document.createElement("a");
    a.href = url; a.download = "live-meeting-report.xls"; a.click();
    URL.revokeObjectURL(url);
  };
            ...
            <div className="flex flex-col space-y-5">
              ...
              <div className="w-full flex gap-3 h-14">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button type="button" className="w-10 h-10 rounded-lg bg-bgray-100 dark:bg-darkblack-500 flex items-center justify-center hover:bg-success-50 transition duration-300" title="Column Visibility">
                ...
                <div className="w-full flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="w-8 h-8 flex items-center justify-center rounded hover:bg-bgray-100 dark:hover:bg-darkblack-500 disabled:opacity-50 disabled:cursor-not-allowed transition duration-300"
                    >
                      <svg width="18" height="18" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M7.72168 5.03271L12.7217 10.0327L7.72168 15.0327" stroke="#A0AEC0" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg>
                    </button>
                  </div>
                </div>
              </div>
