          ...
          <>
               <div className="2xl:flex 2xl:space-x-12">
                    <section className="2xl:flex-1 2xl:mb-0 mb-6 w-full">
                         <div className="w-full py-5 px-6 rounded-lg bg-white dark:bg-darkblack-600 mb-3">
                              <h4 className="text-lg font-bold mb-2">Search Fees Payment</h4>
                              <div className="flex flex-col space-y-5">
                                   <div className="w-full flex h-14 space-x-4">
                                        ...
                                        <button className="py-3.5 flex items-center justify-center text-white font-bold bg-success-300 hover:bg-success-400 transition-all rounded-lg px-5">
                                             Search
                                        </button>
                                   </div>
                              </div>
                                        ...
                                        <table className="w-full">
                                             <thead>
                                                  <tr className="border-b border-bgray-300 dark:border-darkblack-400">
                                                       ...
                                                       <td className="py-5 px-6 text-nowrap">Date</td>
                                                       <td className="py-5 px-6 text-nowrap">Name</td>
                                                       <td className="py-5 px-6 text-nowrap">Class</td>
                                                       <td className="py-5 px-6 text-nowrap">Fees Group</td>
                                                       <td className="py-5 px-6 text-nowrap">Fee Type</td>
                                                       <td className="py-5 px-6 text-nowrap">Mode</td>
                                             ...
                                             <tbody>
                                                  ...
                                                  <tr className="border-b border-bgray-300 dark:border-darkblack-400">
                                                       ...
                                                       <td className="py-5 px-6">Annual Fees</td>
                                                       <td className="py-5 px-6">Tuition Fee</td>
                                                       <td className="py-5 px-6">
                                                            <span className="px-3 py-1 text-white text-sm rounded bg-blue-500">
                                                                 Online
                                                            </span>
                                                       </td>
                                                       <td className="py-5 px-6">$400.00</td>
                                                       <td className="py-5 px-6">$0.00</td>
                                                       <td className="py-5 px-6">$0.00</td>
                                                       <td className="py-5 px-6">
                                                            <div className="relative">
                                                                 ...
                                                                 <div
                                                                      className={`absolute right-0 top-8 bg-white dark:bg-darkblack-500 shadow-lg rounded-lg min-w-[150px] transition-all z-10 ${openFilter === "action" ? "block" : "hidden"
                                                                           }`}
                                                                 >
                                                                      <ul>
                                                                           <li className="px-5 py-2 hover:bg-bgray-100 dark:hover:bg-darkblack-600 cursor-pointer">
                                                                                View Receipt
                                                                           </li>
                                                                           <li className="px-5 py-2 hover:bg-bgray-100 dark:hover:bg-darkblack-600 cursor-pointer">
                                                                                Download
