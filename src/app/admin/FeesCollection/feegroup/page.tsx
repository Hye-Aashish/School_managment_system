                                             ...
                                             <table className="w-full">
                                                  <thead>
                                                       <tr className="border-b border-bgray-300 dark:border-darkblack-400">
                                                            ...
                                                            <td className="py-4 px-4 text-sm font-semibold text-bgray-600 dark:text-bgray-50">Description</td>
                                                  ...
                                                  <tbody>
                                                       ...
                                                       {[
                                                            ...
                                                            "Exam",
                                                            "Fees",
                                                            "Class 4- I Installment",
                                                            "Class 5 General"
                                                       ].map((name, index) => (
                                                            <tr key={index} className="border-b border-bgray-300 dark:border-darkblack-400">
                                                                 <td className="py-3 px-4">
                                                                      <p className="text-sm text-bgray-900 dark:text-white">{name}</p>
                                                                 </td>
                                                                 <td className="py-3 px-4">
                                                                      <p className="text-sm text-bgray-700 dark:text-bgray-300"></p>
                                                                 </td>
                                                                 <td className="py-3 px-4">
                                                                      <div className="flex items-center gap-3">
