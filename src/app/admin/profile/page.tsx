          ...
          <div className="grid grid-cols-1 xl:grid-cols-12 bg-white dark:bg-darkblack-600 rounded-xl">
               ...
               <aside className="col-span-3 border-r border-bgray-200 dark:border-darkblack-400">
                    ...
                    <div className="px-4 py-6">
                         ...
                         >
                              <div
                                   className="w-12 tab-icon transition-all h-12 shrink-0 rounded-full inline-flex items-center justify-center bg-bgray-100 dark:bg-darkblack-500"
                              >
                                   <svg
                         ...
                         >
                              <div
                                   className="w-12 tab-icon transition-all h-12 shrink-0 rounded-full inline-flex items-center justify-center bg-bgray-100"
                              >
                                   <svg
                                        width="24"
                                        height="24"
                         ...
                         >
                              ...
                              <div>
                                   <h4 className="text-base font-bold text-bgray-900 dark:text-white">FAQ</h4>
                                   <p className="text-sm font-medium text-bgray-700 dark:text-darkblack-300 mt-0.5">
                                        Est arcu pharetra proin pellentesque
                                   </p>
                              </div>
                         ...
                         >
                              <div
                                   className="w-12 tab-icon transition-all h-12 shrink-0 rounded-full inline-flex items-center justify-center "
                              >
                                   <svg
                    ...
                    <div className="px-8">
                         <div className="bg-bgray-200 dark:bg-darkblack-500 p-7 rounded-xl">
                              <div
                                   className="flex-row space-x-6 2xl:flex-row 2xl:space-x-6 flex md:flex-col md:space-x-0 items-center"
                              >
                                   <div
                                        className="progess-bar flex justify-center md:mb-[13px] xl:mb-0 mb-0"
                                   >
                                   ...
                                   <div
                                        className="flex flex-col md:items-center xl:items-start items-start"
                                   >
               ...
               <div className="py-8 px-10 col-span-9 tab-content">
                    ...
                    <div id="tab1" className="tab-pane active">
                         <div
                              className="xl:grid grid-cols-12 gap-12 flex 2xl:flex-row flex-col-reverse"
                         >
                              <div className="2xl:col-span-8 xl:col-span-7">
                                   <h3
                                        className="text-2xl font-bold pb-5 text-bgray-900 dark:text-white dark:border-darkblack-400 border-b border-bgray-200"
                                   >
                                   ...
                                   <div className="mt-8">
                                        <form action="">
                                             ...
                                             <h4
                                                  className="pt-8 pb-6 text-xl font-bold text-bgray-900 dark:text-white"
                                             >
                                                  Personal Address
                                             </h4>
                                             <div className="grid 2xl:grid-cols-2 grid-cols-1 gap-6">
                              ...
                              <div className="2xl:col-span-4 xl:col-span-5 2xl:mt-24">
                                   ...
                                   <div>
                                        ...
                                        <div className="relative w-full">
                                             <img
                                                  src="../assets/images/other/cover.jpg"
                                                  className="w-full"
                                                  alt=""
                                             />
                    ...
                    <div id="tab2" className="tab-pane">
                         ...
                         <div className="space-y-5">
                              <div
                                   className="flex sm:flex-row flex-col sm:items-center items-end justify-between pb-5 border-b border-bgray-300 dark:border-darkblack-400"
                              >
                                   ...
                                   <button
                                        type="button"
                                        className="switch-btn text-center relative inline-flex h-5 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none active"
                                        role="switch"
                                        aria-checked="false"
                              ...
                              >
                                   ...
                                   <button
                                        type="button"
                                        className="switch-btn text-center relative inline-flex h-5 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none"
                                        role="switch"
                                        aria-checked="false"
                                        aria-labelledby="availability-label"
                                        aria-describedby="availability-description"
                              ...
                              >
                                   ...
                                   <button
                                        type="button"
                                        className="switch-btn text-center toggle-switch bg-gray-300 relative inline-flex h-5 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none"
                                        role="switch"
                                        aria-checked="false"
                                        aria-labelledby="availability-label"
                                        aria-describedby="availability-description"
                    ...
                    <div id="tab3" className="tab-pane">
                         <div className="grid grid-cols-12">
                              <div
                                   className="2xl:col-span-9 col-span-12 2xl:border-r border-bgray-300"
                              >
                                   <h3 className="text-2xl font-bold text-bgray-900 dark:text-white mb-3">
                                        Folders
                                   </h3>
                                   <div className="flex flex-wrap lg:gap-x-0 gap-3 gap-y-5">
                                        <div
                                             className="flex flex-col items-center md:w-32 md:h-32 w-24 h-24 lg:w-44 lg:h-44"
                                        >
                                             <svg
                                                  width="120"
                                                  height="120"
                                        ...
                                        <div
                                             className="flex flex-col items-center justify-center border-dashed border-2 border-bgray-300 dark:border-darkblack-400 rounded-lg md:w-32 md:h-32 w-24 h-24 lg:w-44 lg:h-44"
                                        >
                                             <button className="flex flex-col items-center">
                                                  <span
                                                       className="w-10 h-10 rounded-lg items-center inline-flex justify-center bg-[#F8F8F8] dark:bg-darkblack-500"
                                                  ><svg
                                                  ...
                                                  <span
                                                       className="block mt-4 text-bgray-500 font-medium text-base"
                                                  >Add Folder</span
                                                  >
                                             </button>
                                        </div>
                                   </div>
                                   <h3 className="text-3xl font-bold text-bgray-900 dark:text-white mb-5 mt-10">
                                        Files
                                   </h3>
                                   <div
                                        className="flex flex-wrap md:gap-x-10 gap-x-3 lg:gap-x-0 gap-y-5"
                                   >
                                        <div
                              ...
                              <div className="col-span-3 2xl:block hidden pl-11 pt-14">
                                   <div className="flex flex-col items-center">
                                        ...
                                        <h3 className="text-2xl text-bgray-600 dark:text-white font-semibold">
                                             Projects
                                        </h3>
                                   </div>
                                   <div>
                                        <h4
                                             className="font-semibold text-base uppercase text-bgray-900 dark:text-white mb-3"
                                        >
                                             Info
                                        </h4>
                                   ...
                                   <div className="pt-7 border-t border-bgray-300 mt-8">
                                        <h3
                                             className="text-base font-semibold text-bgray-900 dark:text-white uppercase mb-4"
                                        >
                                             Settings
                                        </h3>
                                        <div className="flex flex-col space-y-5">
                                             ...
                                             <div className="flex items-center justify-between">
                                                  ...
                                                  <button
                                                       type="button"
                                                       className="switch-btn text-center bg-gray-200 relative inline-flex h-5 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-0 active"
                                                       role="switch"
                                                       aria-checked="false"
                                                       aria-labelledby="availability-label"
                                                       aria-describedby="availability-description"
                                             ...
                                             <div className="flex items-center justify-between">
                                                  ...
                                                  <button
                                                       type="button"
                                                       className="switch-btn text-center bg-gray-200 relative inline-flex h-2/5 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-0"
                                                       role="switch"
                                                       aria-checked="false"
                                                       aria-labelledby="availability-label"
                                                       aria-describedby="availability-description"
                    ...
                    <div id="tab4" className="tab-pane">
                         ...
                         <div>
                              ...
                              <div
                                   className="grid 2xl:grid-cols-3 sm:grid-cols-2 grid-cols-1 2xl:gap-10 gap-5 pb-14"
                              >
                                   ...
                                   <div className="relative p-6 bg-gray-100 dark:bg-darkblack-500 rounded-lg">
                                        <div className="mb-5">
                                             <img src="assets/images/payments/amazon.svg" className="block dark:hidden" alt="" />
                                             <img src="assets/images/payments/amazon-white.svg" className="hidden dark:block" alt="" />
                                        </div>
                                        <h4 className="text-base font-bold text-bgray-900 dark:text-white mb-2">
                                             Amazon
                                        </h4>
                                   ...
                                   <div className="relative p-6 bg-gray-100 dark:bg-darkblack-500 rounded-lg">
                                        <div className="mb-5">
                                             <img
                                                  src="assets/images/payments/payoner.svg" className="block dark:hidden"
                                                  alt=""
                                             />
                                             <img src="assets/images/payments/payoneer-white.svg" className="hidden dark:block" alt="" />
                                        </div>
                                        <h4 className="text-base font-bold text-bgray-900 dark:text-white mb-2">
                                             Payoner
                                        </h4>
                                   ...
                                   >
                                        ...
                                        <span className="text-lg text-bgray-600 font-medium"
                                        >Add wallet</span
                                        >
                                   </div>
                              </div>
                         ...
                         <div
                              className="lg:border-t border-bgray-300 dark:border-darkblack-400 lg:px-7 lg:py-10 px-0 py-0"
                         >
                              <div className="lg:flex justify-between items-center">
                                   <div
                                        className="2xl:w-[400px] lg:w-[250px] w-full flex flex-col items-center"
                                   >
                                        ...
                                        <div className="card-slider w-full relative">
                                   ...
                                   <div
                                        className="w-1 h-[220px] bg-bgray-200 dark:bg-darkblack-400 lg:block hidden rounded-lg"
                                   ></div>
                                        ...
                                        <div className="w-full">
                                             ...
                                             <div className="payment-select relative mb-3">
                                                  <button
                                                       ...
                                                       type="button"
                                                       className="px-5 w-full h-14 border border-bgray-200 dark:border-darkblack-400 flex justify-between items-center rounded-lg overflow-hidden"
                                                  >
                                                       ...
                                                       <div className="flex space-x-2 items-center">
                                                            ...
                                                            <span
                                                                 className="text-sm font-medium text-bgray-900"
                                                            >
                                                                 <svg
                                                                      width="16"
                                                                      height="16"
                                                  ...
                                                  <div
                                                       id="paymentFilter"
                                                       className="rounded-lg shadow-lg w-full bg-white absolute right-0 z-10 top-full hidden overflow-hidden"
                                                  >
                                                       <ul>
                                                            <li
                                                                 // onclick="dateFilterAction('#paymentFilter')"
                                             ...
                                             <div
                                                  className="w-full rounded-lg border border-bgray-200 dark:border-darkblack-400 focus-within:border-success-300 p-4 h-[98px] flex flex-col justify-between"
                                             >
                                                  <p className="text-sm text-bgray-600 dark:text-darkblack-300 font-medium">
                                                       Enter amount
                                                  </p>
                                                  <div
                                                       className="w-full h-[35px] flex justify-between items-center"
                                                  >
                              ...
                              <div>
                                   ...
                                   <div className="transition">
                                        ...
                                        >
                                             ...
                                             <h2
                                                  className="title transition-all text-bgray-900 dark:text-white md:text-lg text-sm font-bold "
                                             >
                                        ...
                                        >
                                             <div className="flex flex-row py-6">
                                                  <div
                                                       className="flex h-[93] w-1 bg-success-300 rounded-lg"
                                                  ></div>
                                                  <div className="flex-1">
                                                       <p
                                                            className="text-[#9AA2B1] pl-4 lg:text-base text-xs lg:leading-7"
                                                       >
                                   ...
                                   <div className="transition">
                                        <div
                                             className="accordion-header border-b border-bgray-300 dark:border-darkblack-400 cursor-pointer transition flex space-x-5 items-center h-16"
                                        >
                                             <i className="fas fa-plus text-success-300 text-xl"></i>
                                             <h2
                                                  className="title transition-all text-bgray-900 md:text-lg text-sm dark:text-white"
                                             >
                                   ...
                                   <div className="transition">
                                        ...
                                        >
                                             <i className="fas fa-plus text-success-300 text-xl"></i>
                                             <h2
                                                  className="title transition-all text-bgray-900 dark:text-white md:text-lg text-sm"
                                             >
                              ...
                              <div className="grow max-w-[614px]">
                                   ...
                                   <form action="" className="mt-6">
                                        <div className="relative flex flex-col mb-6">
                                             <label className="text-sm block mb-3 font-medium text-bgray-500 dark:text-darkblack-300">Old password</label>
                                             <input
                                                  type="text"
                                        ...
                                        <div className="relative flex flex-col mb-6">
                                             <label className="text-sm block mb-3 font-medium text-bgray-500 dark:text-darkblack-300">New password</label>
                                             <input
                                                  type="text"
                    ...
                    <div id="tab7" className="tab-pane">
                         <div>
                              ...
                              <blockquote
                                   className="px-7 py-5 bg-bgray-100 dark:bg-darkblack-500 rounded-lg mb-8 text-lg text-bgray-800 dark:text-white"
                              >
