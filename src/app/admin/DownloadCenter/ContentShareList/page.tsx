                                             ...
                                             <tr key={item._id} className="hover:bg-bgray-50/50 transition-colors group">
                                                  ...
                                                  <td className="px-8 py-7 text-right">
                                                       <div className="flex justify-end gap-2">
                                                            {item.fileUrl && (
                                                                 <a href={item.fileUrl.startsWith('http') ? item.fileUrl : `https://${item.fileUrl}`} target="_blank" rel="noopener noreferrer" className="p-2.5 bg-bgray-50 dark:bg-darkblack-500 rounded-xl text-bgray-400 hover:text-success-300 transition-all">
