                                        ...
                                        <div className="w-full space-y-4">
                                             ...
                                             <div className="w-full">
                                                  ...
                                                  <textarea
                                                       name="description"
                                                       rows={4}
                                                       className="w-full px-4 py-3 border border-bgray-300 dark:border-darkblack-400 rounded-lg focus:outline-none focus:border-success-300 bg-white dark:bg-darkblack-500 text-bgray-900 dark:text-white resize-none"
                                   ...
                                   <div className="flex flex-col space-y-5">
                                        ...
                                        <div className="table-content w-full min-h-[52vh] overflow-x-auto">
                                             <table className="w-full">
                                                  ...
                                                  <tbody>
                                                       {[
                                                            { name: "Content Type Material", description: "No Description" },
                                                            { name: "Exam material", description: "No Description" },
                                                            { name: "Other Downloads", description: "No Description" },
                                                            { name: "Study Material", description: "No Description" },
                                                            { name: "Syllabus", description: "No Description" },
                                                            { name: "Assignment", description: "Assignment" },
                                                       ].map((item, index) => (
                                                                 ...
                                                                 <td className="py-5 px-6 xl:px-0">
                                                                      <div className="flex items-center justify-end space-x-3">
                                                                           ...
                                                                           >
                                                                                ...
                                                                                >
                                                                                     <path
                                                                                          d="M13.5 1.5L16.5 4.5L6 15H3V12L13.5 1.5Z"
                                                                                          stroke="currentColor"
                                                                                          strokeWidth="1.5"
                                                                                          strokeLinecap="round"
                                                                                          strokeLinejoin="round"
