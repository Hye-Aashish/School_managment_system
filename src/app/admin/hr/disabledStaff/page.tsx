...
export default function DisabledStaffDirectory() {
     ...
     const emptyForm = {
          ...
          workExperience: "", password: "", status: "Disabled"
     };
     ...
     const fetchStaff = async () => {
          setLoading(true);
          const res = await fetch("/api/staff?status=Disabled");
               ...
               <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    {loading ? (
                         ...
                         filteredStaff.map((s) => (
                              <div key={s._id} className="bg-white dark:bg-darkblack-600 rounded-3xl p-6 shadow-sm border border-bgray-200 dark:border-darkblack-400 hover:shadow-xl hover:shadow-success-300/5 transition-all group relative overflow-hidden">
                                   <div className="absolute top-0 right-0 p-4">
                                        <span className="px-3 py-1 bg-red-400/10 text-red-500 rounded-full text-[9px] font-black uppercase tracking-widest">{s.role}</span>
                                   </div>
                                   <div className="flex flex-col items-center text-center mt-4">
                                        <div className="w-20 h-20 bg-bgray-50 dark:bg-darkblack-500 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform bg-gradient-to-br from-red-400/20 to-transparent">
                                             <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#F87171" strokeWidth="1.5"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                        </div>
                         ...
                         <div className="col-span-full py-32 text-center opacity-20">
                              ...
                              <p className="text-[12px] font-black uppercase tracking-[0.3em]">No disabled personnel</p>
                         </div>
                    )}
               </section>
                    ...
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                         ...
                         <div className="relative bg-white dark:bg-darkblack-600 rounded-[40px] w-full max-w-4xl shadow-2xl overflow-hidden animate-in zoom-in duration-300 border border-success-300/20">
                              <div className="p-8 border-b border-bgray-100 dark:border-darkblack-400 flex justify-between items-center bg-bgray-50/50">
                                   <div>
                                        <h3 className="text-2xl font-black dark:text-white uppercase tracking-tighter">Review Profile</h3>
                                        <p className="text-[10px] font-bold text-bgray-400 uppercase tracking-widest">Editing details of existing institutional workforce member</p>
                                   </div>
                              ...
                              <form onSubmit={handleSubmit} className="p-8 max-h-[70vh] overflow-y-auto custom-scrollbar">
                                   ...
                                   <div className="flex justify-end gap-3 pt-4 border-t border-bgray-100 dark:border-darkblack-400 mt-8">
                                        ...
                                        <button type="submit" className="px-12 h-14 bg-success-300 text-white font-black rounded-2xl hover:bg-success-400 shadow-xl shadow-success-300/20 transition-all uppercase tracking-widest text-[10px]">Save changes</button>
                                   </div>
                              </form>
                         </div>
                    </div>
