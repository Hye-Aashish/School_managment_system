                         ...
                         <div className="flex flex-col space-y-5">
                              ...
                              <div className="w-full flex h-14 space-x-4">
                                   ...
                                   <div className="relative">
                                        ...
                                        >
                                             <span className="text-base text-bgray-500 text-nowrap">Select Role</span>
                                             <span>
                                                  <svg
                                                       width="21"
                                                       height="21"
                                   ...
                                   <div className="relative">
                                        <button
                                             ...
                                             onClick={() => toggleFilter("export")}
                                        >
                                             <span className="text-base text-bgray-500 text-nowrap">Select Month</span>
                                             <span>
                                                  <svg
                                                       width="21"
                                                       height="21"
                                   ...
                                   <div className="relative">
                                        <button
                                             ...
                                             onClick={() => toggleFilter("export")}
                                        >
                                             <span className="text-base text-bgray-500 text-nowrap">Select Year</span>
                                             <span>
                                                  <svg
                                                       width="21"
                                                       height="21"
                                        ...
                                        <tbody>
                                             {staffData.map((staff) => (
                                                  ...
                                                  >
                                                       ...
                                                       <td className="py-5 px-6 xl:px-0">
                                                            <span className="px-3 py-1.5 text-xs font-semibold text-white bg-orange-500 rounded">
                                                                 {staff.status}
                                                            </span>
                                                       </td>
                                                       <td className="py-5 px-6 xl:px-0">
                                                            <div className="flex items-center space-x-3">
                                                                 ...
                                                                 >
                                                                      ...
                                                                      >
                                                                           <path
                                                                                d="M14.25 3.75C14.25 3.75 11.8995 1.5 9 1.5C5.27208 1.5 2.25 4.52208 2.25 8.25C2.25 11.9779 5.27208 15 9 15C12.0985 15 14.7031 12.8889 15.4425 10.0312"
                                                                                stroke="currentColor"
                                                                                strokeWidth="1.5"
                                                                                strokeLinecap="round"
                                                                                strokeLinejoin="round"
                                                                 ...
                                                                 <button
                                                                      type="button"
                                                                      className="px-4 py-1.5 text-xs font-semibold text-white bg-bgray-600 hover:bg-bgray-600 dark:bg-bgray-600 dark:hover:bg-bgray-700 rounded transition-all"
                                                                 >
                                                                      Proceed To Pay
                                                                 </button>
                                                            </div>
