     ...
     return (
          <>
               <div className="2xl:flex 2xl:space-x-12">
                    {/* Left Section - Add Designation Form */}
                    <section className="2xl:w-[400px] 2xl:mb-0 mb-6">
                         <div className="w-full py-5 px-6 rounded-lg bg-white dark:bg-darkblack-600">
                              ...
                              <div className="flex flex-col space-y-5">
                                   ...
                                   <button
                                        type="button"
                                        className="py-3.5 flex items-center justify-center text-white font-bold bg-bgray-600 hover:bg-bgray-600 transition-all rounded-lg w-full"
                                   >
                                        Save
                                   </button>
                              </div>
                    ...
                    {/* Right Section - Designation Lists */}
