...
export default function PrintMarksheet() {
     ...
     const handleGenerate = () => {
          ...
          alert(`Generating Marksheets for ${selectedStudents.length} students using template: ${selectedTemplate.templateName}`);
     };
                                   ...
                                   <div className="w-full">
                                        ...
                                        <div className="table-content w-full overflow-x-auto min-h-[400px]">
                                             <table className="w-full">
                                                  ...
                                                  <tbody>
                                                       {loading ? (
                                                            <tr><td colSpan={5} className="py-20 text-center text-bgray-500 dark:text-bgray-300">Loading students...</td></tr>
                                                       ) : students.length === 0 ? (
                                                            <tr><td colSpan={5} className="py-20 text-center text-bgray-500 dark:text-bgray-300">No students found</td></tr>
                                                       ) : students.map(s => (
